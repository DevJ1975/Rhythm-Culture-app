...
import { UserProfile, Post, Collaboration, ArtistSpecialty, Event, Course, Notification, GovConOpportunity, GovConBid, GovConProfile } from '../../models';
...
export class MockDataService {
  ...
  getGovConOpportunities(): GovConOpportunity[] {
    return [
      {
        id: 'opp-001',
        samOpportunityId: 'SAM-2026-001',
        title: 'Cultural Arts Performance Services for Military Installations',
        solicitationNumber: 'W91QUZ-26-R-0042',
        type: 'Solicitation',
        agency: 'Department of Defense',
        office: 'Army MWR',
        description: 'Seeking performing arts groups to provide live entertainment, dance performances, and musical shows at military installations across the southeastern United States. Services include concert performances, cultural showcases, and holiday entertainment events.',
        naicsCodes: ['711130', '711190'],
        setAside: 'Small Business',
        postedDate: ts(5),
        responseDeadline: future(25),
        estimatedValue: 250000,
        placeOfPerformance: { city: 'Fort Liberty', state: 'NC', country: 'US' },
        pointOfContact: { name: 'Sarah Mitchell', email: 'sarah.mitchell@army.mil', phone: '910-555-0142' },
        status: 'active',
        matchedSpecialties: ['Music', 'Dance'],
        createdAt: ts(5),
        updatedAt: ts(5),
      },
      {
        id: 'opp-002',
        samOpportunityId: 'SAM-2026-002',
        title: 'Youth Dance Education Program — State Department Cultural Exchange',
        solicitationNumber: 'SAQMMA26R0018',
        type: 'Combined Synopsis',
        agency: 'Department of State',
        office: 'Bureau of Educational and Cultural Affairs',
        description: 'The Bureau of Educational and Cultural Affairs seeks qualified dance companies and choreographers to develop and deliver youth dance education programs as part of international cultural exchange initiatives. Programs will operate in 5 partner countries.',
        naicsCodes: ['711120', '611610'],
        setAside: '8(a)',
        postedDate: ts(3),
        responseDeadline: future(18),
        estimatedValue: 500000,
        placeOfPerformance: { city: 'Washington', state: 'DC', country: 'US' },
        pointOfContact: { name: 'James Rodriguez', email: 'rodriguezjc@state.gov' },
        status: 'active',
        matchedSpecialties: ['Dance', 'Choreography'],
        createdAt: ts(3),
        updatedAt: ts(3),
      },
      {
        id: 'opp-003',
        samOpportunityId: 'SAM-2026-003',
        title: 'Music Production Services for VA Healing Arts Program',
        solicitationNumber: 'VA256-26-Q-0091',
        type: 'Sources Sought',
        agency: 'Department of Veterans Affairs',
        office: 'Veterans Health Administration',
        description: 'The VA seeks sources for music therapy and production services to support the Healing Arts program at VA medical centers. Services include live music sessions, recording studio time for veterans, and music production workshops.',
        naicsCodes: ['711130', '512240'],
        setAside: 'SDVOSB',
        postedDate: ts(1),
        responseDeadline: future(30),
        estimatedValue: 175000,
        placeOfPerformance: { state: 'Multiple', country: 'US' },
        pointOfContact: { name: 'Dr. Lisa Chen', email: 'lisa.chen2@va.gov' },
        status: 'active',
        matchedSpecialties: ['Music', 'Production'],
        createdAt: ts(1),
        updatedAt: ts(1),
      },
      {
        id: 'opp-004',
        samOpportunityId: 'SAM-2026-004',
        title: 'Theater Production for National Park Service Interpretive Programs',
        solicitationNumber: 'P26PS00184',
        type: 'Presolicitation',
        agency: 'Department of Interior',
        office: 'National Park Service',
        description: 'Pre-solicitation notice for theater companies to provide historical interpretive performances at national parks. Performances should blend education with entertainment, bringing American history to life through theatrical productions.',
        naicsCodes: ['711110', '711190'],
        setAside: 'Small Business',
        postedDate: ts(7),
        responseDeadline: future(45),
        estimatedValue: 320000,
        placeOfPerformance: { state: 'Multiple', country: 'US' },
        pointOfContact: { name: 'Mark Thompson', email: 'mark_thompson@nps.gov' },
        status: 'active',
        matchedSpecialties: ['Acting', 'Directing'],
        createdAt: ts(7),
        updatedAt: ts(7),
      },
      {
        id: 'opp-005',
        samOpportunityId: 'SAM-2026-005',
        title: 'Video Production Services — GSA Federal Media Center',
        solicitationNumber: 'GS-00F-26-0033',
        type: 'Solicitation',
        agency: 'General Services Administration',
        office: 'Federal Acquisition Service',
        description: 'GSA requires video production and post-production services for federal agency communications. Scope includes concept development, filming, editing, motion graphics, and distribution for training and public-facing content.',
        naicsCodes: ['512110'],
        setAside: 'WOSB',
        postedDate: ts(2),
        responseDeadline: future(14),
        estimatedValue: 450000,
        placeOfPerformance: { city: 'Washington', state: 'DC', country: 'US' },
        pointOfContact: { name: 'Angela Williams', email: 'angela.williams@gsa.gov' },
        status: 'active',
        matchedSpecialties: ['Videography', 'Directing', 'Production'],
        createdAt: ts(2),
        updatedAt: ts(2),
      },
      {
        id: 'opp-006',
        samOpportunityId: 'SAM-2026-006',
        title: 'Concert Promotion and Event Management — Air Force Bases',
        solicitationNumber: 'FA4890-26-R-0007',
        type: 'Solicitation',
        agency: 'Department of the Air Force',
        office: 'Air Force Services',
        description: 'Seeking experienced concert promoters and event management companies to plan and execute live music events and entertainment programs at Air Force installations worldwide. Includes booking talent, stage management, sound/lighting, and marketing.',
        naicsCodes: ['711310', '711320'],
        setAside: 'Small Business',
        postedDate: ts(4),
        responseDeadline: future(20),
        estimatedValue: 600000,
        placeOfPerformance: { state: 'Multiple', country: 'US' },
        pointOfContact: { name: 'Col. David Park', email: 'david.park@us.af.mil' },
        status: 'active',
        matchedSpecialties: ['Music', 'DJ', 'Production'],
        createdAt: ts(4),
        updatedAt: ts(4),
      },
    ] as GovConOpportunity[];
  }

  getGovConBids(): GovConBid[] {
    return [
      {
        id: 'bid-001',
        ...
        dueDate: future(25),
        notes: 'Need to finalize team roster and past performance references',
        createdAt: ts(3),
        updatedAt: ts(1),
      },
      {
        ...
        status: 'tracking',
        dueDate: future(18),
        notes: 'Evaluating teaming partner options',
        createdAt: ts(2),
        updatedAt: ts(2),
      },
      {
        ...
        dueDate: future(14),
        submittedAt: ts(1),
        notes: 'Submitted on time with all attachments',
        createdAt: ts(10),
        updatedAt: ts(1),
      },
      {
        id: 'bid-004',
        opportunityId: 'opp-prev-001',
        opportunity: {
          id: 'opp-prev-001',
          title: 'NEA Regional Arts Showcase Production',
          agency: 'National Endowment for the Arts',
          responseDeadline: ts(30),
          setAside: 'Small Business',
        },
        userId: 'user-demo',
        status: 'won',
        ...
        dueDate: ts(30),
        submittedAt: ts(45),
        notes: 'Contract awarded! Kick-off meeting scheduled.',
        createdAt: ts(60),
        updatedAt: ts(15),
      },
      {
        id: 'bid-005',
        opportunityId: 'opp-prev-002',
        opportunity: {
          id: 'opp-prev-002',
          title: 'USMC Band Support Services',
          agency: 'Department of Defense',
          responseDeadline: ts(60),
          setAside: 'None',
        },
        userId: 'user-demo',
        status: 'lost',
        ...
        dueDate: ts(60),
        submittedAt: ts(65),
        notes: 'Lost to incumbent — need stronger past performance next time',
        createdAt: ts(90),
        updatedAt: ts(45),
      },
    ] as GovConBid[];
  ...
  getGovConProfile(): GovConProfile {
    return {
      userId: 'user-demo',
      ueiNumber: 'EXAMPLE1234567',
      cageCode: '8ABC9',
      naicsCodes: ['711130', '711190', '512110'],
      samRegistrationStatus: 'active',
      samExpirationDate: future(180),
      setAsideEligibility: ['Small Business'],
      pastPerformance: [
        {
          agency: 'National Endowment for the Arts',
          contractNumber: 'NEA-2025-PP-0034',
          value: 95000,
          periodStart: ts(365),
          periodEnd: ts(180),
          description: 'Produced and managed regional arts showcase featuring 12 performing arts groups across 3 cities.',
        },
        {
          agency: 'Department of Defense — Army MWR',
          contractNumber: 'W91QUZ-24-C-0088',
          value: 55000,
          periodStart: ts(540),
          periodEnd: ts(400),
          description: 'Provided live musical entertainment for military family events at Fort Liberty.',
        },
      ],
      capabilitySummary: 'Multi-disciplinary performing arts company specializing in live music, dance, and video production. Experienced in government cultural programs and military entertainment.',
      createdAt: ts(180),
      updatedAt: ts(5),
    } as GovConProfile;
  }
